...
(function() {
  ...
  (function($) {
    var PtGoogleMap, defaultMapOptions, geocoder, librariesLoading, loadScript, loaderCallbacks, ptGoogleMaps, runCallbacks, selectedDestinationAddress;
    ...
    */
    ...
    return $.fn.ptGoogleMap = function(options, idx) {
      var $self;
